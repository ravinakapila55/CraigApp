...
public class ReceivedMessageViewHolder extends RecyclerView.ViewHolder {
    ...
    public ReceivedMessageViewHolder(View view) {
        super(view);
        txt_recieve = view.findViewById(R.id.txt_recieve);
...
/*        String splitTime[] = time.split(":");
        ...
        int hour = Integer.valueOf(splitTime[0]) + 05;
        int minute = Integer.valueOf(splitTime[1]) + 30;

        String displayTime = getFormatedDateTime(String.valueOf(hour) + ":" + String.valueOf(minute), "yyyy-MM-dd HH:mm:ss", "hh:mm a");*/
