package com.helper.Helper2Go.duonavigationdrawer.views;
...
public class DuoOptionView extends RelativeLayout {
    ...
    private class OptionViewHolder {
        ...
        OptionViewHolder(ViewGroup rootView) {
            mTextViewOption = rootView.findViewById(R.id.duo_view_option_text);
            mImageViewSelector = rootView.findViewById(R.id.duo_view_option_selector);
            mImageViewSelectorSide = rootView.findViewById(R.id.duo_view_option_selector_side);
